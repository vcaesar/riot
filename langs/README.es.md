...
Las versiones ejecutables de los tres programas están en [`test/readme_demo`](../test/readme_demo).
...
texto CJK, además de búsqueda por cadena de consulta y resaltado. Guarda como `gse/main.go` y ejecuta con
`go run ./gse`:
